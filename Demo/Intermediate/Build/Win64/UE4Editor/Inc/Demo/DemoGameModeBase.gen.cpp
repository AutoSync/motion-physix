...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ADemoGameModeBase_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_ADemoGameModeBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ADemoGameModeBase_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ADemoGameModeBase, 1501380478);
	template<> DEMO_API UClass* StaticClass<ADemoGameModeBase>()
	{
		return ADemoGameModeBase::StaticClass();
	}
